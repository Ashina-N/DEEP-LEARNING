...
def predictcnn(fn):
    ...
    mo = load_model("C:\\Users\\ASUS\\PycharmProjects\\covid\\app\\static\\model1.h5")
    dataset /= 255
...
# predictcnn(r"C:\Users\s\PycharmProjects\covid\app\static\newdataset\COVID\Covid_3.png")
